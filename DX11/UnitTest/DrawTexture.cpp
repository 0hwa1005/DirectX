...
void DrawTexture::Initialize()
{
	...
	//D3DX11CreateShaderResourceViewFromFile(D3D::GetDevice(), L"../../_Textures/Box.png", NULL, NULL, &srv, NULL);
...
void DrawTexture::Render()
{
	...
	D3D::GetDC()->IASetPrimitiveTopology(D3D11_PRIMITIVE_TOPOLOGY_TRIANGLELIST);//LINELIST-LINESTRIP
