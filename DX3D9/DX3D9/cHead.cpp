...
void cHead::Setup()
{
...

	{
		...
		m_vecVertex[14].t.x = (float)24 / 64;	m_vecVertex[14].t.y = (float)8 / 64;	 //¿ÞÂÊ¸é À­»ï°¢
																						 //4,5,1
		...
		m_vecVertex[20].t.x = (float)8 / 64;	m_vecVertex[20].t.y = (float)8 / 64;	 //¿À¸¥¸é À­»ï°¢
																						 //3,2,6

		m_vecVertex[21].t.x = (float)0 / 64;	m_vecVertex[21].t.y = (float)16 / 64;
		m_vecVertex[22].t.x = (float)8 / 64;	m_vecVertex[22].t.y = (float)8 / 64;
		m_vecVertex[23].t.x = (float)8 / 64;	m_vecVertex[23].t.y = (float)16 / 64;	 //¿À¸¥¸é ¾Æ·§»ï°¢
																						 //3,6,7

		m_vecVertex[24].t.x = (float)8 / 64;	m_vecVertex[24].t.y = (float)0 / 64;
		m_vecVertex[25].t.x = (float)8 / 64;	m_vecVertex[25].t.y = (float)8 / 64;
		m_vecVertex[26].t.x = (float)16 / 64;	m_vecVertex[26].t.y = (float)8 / 64;	 //À­¸é À­»ï°¢
																						 //1,5,6

		m_vecVertex[27].t.x = (float)8 / 64;	m_vecVertex[27].t.y = (float)0 / 64;
		m_vecVertex[28].t.x = (float)16 / 64;	m_vecVertex[28].t.y = (float)8 / 64;
		m_vecVertex[29].t.x = (float)16 / 64;	m_vecVertex[29].t.y = (float)0 / 64;	 //À­¸é ¾Æ·§»ï°¢
																						 //1,6,2
		m_vecVertex[30].t.x = (float)16 / 64;	m_vecVertex[30].t.y = (float)0 / 64;
		m_vecVertex[31].t.x = (float)16 / 64;	m_vecVertex[31].t.y = (float)8 / 64;
		m_vecVertex[32].t.x = (float)24 / 64;	m_vecVertex[32].t.y = (float)8 / 64;	 //¾Æ·§¸é À­»ï°¢
																						 //4,0,3

		m_vecVertex[33].t.x = (float)16 / 64;	m_vecVertex[33].t.y = (float)0 / 64;
		m_vecVertex[34].t.x = (float)24 / 64;	m_vecVertex[34].t.y = (float)8 / 64;
		m_vecVertex[35].t.x = (float)24 / 64;	m_vecVertex[35].t.y = (float)0 / 64;	 //¾Æ·§¸é ¾Æ·§»ï°¢
	}
